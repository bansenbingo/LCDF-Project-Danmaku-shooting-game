...
#                script (type 'ROM_f.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="Z:/LCDF-Project-Danmaku-shooting-game/Danmaku-Shooting/Danmaku-Shooting.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then

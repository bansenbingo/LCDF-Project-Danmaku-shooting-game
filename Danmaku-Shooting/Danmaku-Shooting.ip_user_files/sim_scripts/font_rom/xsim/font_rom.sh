...
#
# Script generated by Vivado on Thu Jun 25 19:29:38 +0800 2026
...
#
# Usage        : font_rom.sh
#                font_rom.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                font_rom.sh [-reset_run]
#                font_rom.sh [-reset_log]
#                font_rom.sh [-help]
#
...
# script info
echo -e "font_rom.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./font_rom.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L dist_mem_gen_v8_0_17 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot font_rom xil_defaultlib.font_rom xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb font_rom.wdb xsim.dir libdpi.so)
...
Usage: font_rom.sh [-step]\n\
Usage: font_rom.sh [-lib_map_path]\n\
Usage: font_rom.sh [-reset_run]\n\
Usage: font_rom.sh [-reset_log]\n\
Usage: font_rom.sh [-keep_index]\n\
